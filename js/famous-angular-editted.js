      ...
      compile: function (tElement, tAttrs, transclude) {
        return {
          pre: function (scope, element, attrs) {
            ...
            // Hacky fix to have fa-app update context upon height / width changes
            scope.$watch(function() {
              return angular.element(element).width() + angular.element(element).height(); 
            }, function() {
              isolate.context.setSize([angular.element(element).width(), angular.element(element).height()]); 
            });
